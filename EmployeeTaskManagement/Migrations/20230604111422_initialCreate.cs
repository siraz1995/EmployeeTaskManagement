        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoleId = table.Column<string>(type: "nvarchar(127)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    ClaimType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClaimValue = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoginProvider = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    ProviderKey = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    ProviderDisplayName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    AppUserId = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    RoleId = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    AppUserId = table.Column<string>(type: "nvarchar(127)",maxLength:127, nullable: false)
                },
                constraints: table =>
                {
